...
Finnally, [RaptorJIT](https://github.com/raptorjit/raptorjit.git) is also bundleded as Lua is the easiest interpreted language that is really C / C++ friendly, and as Mike Pall's creation is aweasome but a bit too big for beeing understandable for a majority of programmers. 
